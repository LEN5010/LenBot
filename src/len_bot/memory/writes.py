...
async def validate_memory_proposal(
    ...
    for ev_id in mp.evidence:
        ...
        if row:
            ...
            if row[0] in {"SOCIAL_COGNITION_RECORDED", "REFLECTION_RECORDED", "ACTION_SHADOWED", "TASK_REVIEW", "AGENT_JOB_FINISHED", "AGENT_JOB_PROGRESS", "AGENT_JOB_CHECKPOINT", "AGENT_JOB_CONTROL", "OPERATOR_ACTION", "REPLY_FEEDBACK_LABELLED", "ROLLOUT_UPDATED"}:
        ...
        for source in sources:
            ...
            if not original or original[0] in {"SOCIAL_COGNITION_RECORDED", "REFLECTION_RECORDED", "ACTION_SHADOWED", "TASK_REVIEW", "AGENT_JOB_FINISHED", "AGENT_JOB_PROGRESS", "AGENT_JOB_CHECKPOINT", "AGENT_JOB_CONTROL", "OPERATOR_ACTION", "REPLY_FEEDBACK_LABELLED", "ROLLOUT_UPDATED"}:
