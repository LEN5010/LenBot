...
function askRetry(batch) { retryConfirmation.value = { id: batch.id, scene: sceneId.value, range: `${batch.start_rowid}:${batch.start_offset} → ${batch.end_rowid}:${batch.end_offset}`, error: batch.error_type }; retryError.value = '' }
