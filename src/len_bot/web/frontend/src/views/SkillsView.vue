...
<template>
  <div class="page-stack">
    ...
    <p class="muted">{{ tab === 'saved' ? '自动技能限来源场景使用，只有运营明确公开的版本可跨场景读取。人工内容不会被自动整理覆盖。' : '候选尚不代表已生效能力；整理失败、中断和过期状态按真实记录展示。' }}</p>
