...
class ContextAssembler:
    ...
    def assemble(
        ...
        system_content = (
            ...
            f"5. 如果当前存在活跃的对话线索 (Participation Thread)，且当前消息与该线索相关，你可以自然延续对话；如果话题已经转移或者群友在聊其他不属于你的事情，请保持 SILENCE 并在 state_annotations 中提出 close_thread: True。\n"
        ...
        user_content = (
            ...
            f'{{"disposition": "SILENCE" | "ACTION", "thought": "...", "message_proposals": [{{"content": "..."}}], "task_proposals": [], "memory_proposals": [], "resolve_open_loop_ids": [], "retained_item_proposals": []}}\n'
