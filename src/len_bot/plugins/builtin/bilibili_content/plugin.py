...
class BilibiliContentPlugin(BasePlugin):
    ...
    async def _get_video_info(self, args: dict[str, Any], call_context: PluginCallContext) -> ToolResult:
    ...
    async def _search_bilibili(self, args: dict[str, Any], call_context: PluginCallContext) -> ToolResult:
    ...
    async def _get_dynamic_feed(self, args: dict[str, Any], call_context: PluginCallContext) -> ToolResult:
        if not args.get("mid"):
